/*
*********************************************************************
RealPars SQL Training 
*********************************************************************
Name: MySQL Sample Database realparsmodels
...
insert  into `students`(`studentNumber`,`LastName`,`FirstName`,`phone`,`addressLine1`,`addressLine2`,`city`,`state`,`postalCode`,`country`,`salesRepEmployeeNumber`,`creditLimit`) values 

(103,'Schmitt','Carine ','40.32.2555','54, rue Royale',NULL,'Nantes',NULL,'44000','France',1370,'21000.00'),

(112,'King','Jean','7025551838','8489 Strong St.',NULL,'Las Vegas','NV','83030','USA',1166,'71800.00'),

(114,'Ferguson','Peter','03 9520 4555','636 St Kilda Road','Level 3','Melbourne','Victoria','3004','Australia',1611,'117300.00'),

(119,'Labrune','Janine ','40.67.8555','67, rue des Cinquante Otages',NULL,'Nantes',NULL,'44000','France',1370,'118200.00'),

(121,'Bergulfsen','Jonas ','07-98 9555','Erling Skakkes gate 78',NULL,'Stavern',NULL,'4110','Norway',1504,'81700.00'),

(124,'Nelson','Susan','4155551450','5677 Strong St.',NULL,'San Rafael','CA','97562','USA',1165,'210500.00'),

(125,'Piestrzeniewicz','Zbyszek ','(26) 642-7555','ul. Filtrowa 68',NULL,'Warszawa',NULL,'01-012','Poland',NULL,'0.00'),

(128,'Keitel','Roland','+49 69 66 90 2555','Lyonerstr. 34',NULL,'Frankfurt',NULL,'60528','Germany',1504,'59700.00'),

(129,'Murphy','Julie','6505555787','5557 North Pendale Street',NULL,'San Francisco','CA','94217','USA',1165,'64600.00'),

(131,'Lee','Kwai','2125557818','897 Long Airport Avenue',NULL,'NYC','NY','10022','USA',1323,'114900.00'),

(141,'Freyre','Diego ','(91) 555 94 44','C/ Moralzarzal, 86',NULL,'Madrid',NULL,'28034','Spain',1370,'227600.00'),

(144,'Berglund','Christina ','0921-12 3555','Berguvsvägen  8',NULL,'Luleå',NULL,'S-958 22','Sweden',1504,'53100.00'),

(145,'Petersen','Jytte ','31 12 3555','Vinbæltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,'83400.00'),

(146,'Saveley','Mary ','78.32.5555','2, rue du Commerce',NULL,'Lyon',NULL,'69004','France',1337,'123900.00'),

(148,'Natividad','Eric','+65 221 7555','Bronz Sok.','Bronz Apt. 3/6 Tesvikiye','Singapore',NULL,'079903','Singapore',1621,'103800.00'),

(151,'Young','Jeff','2125557413','4092 Furth Circle','Suite 400','NYC','NY','10022','USA',1286,'138500.00');
...
(1002,'Murphy','Diane','x5800','dmurphy@realparssamplesql.com','1',NULL,'President'),

(1056,'Patterson','Mary','x4611','mpatterso@realparssamplesql.com','1',1002,'VP Sales'),

(1076,'Firrelli','Jeff','x9273','jfirrelli@realparssamplesql.com','1',1002,'VP Marketing'),

(1088,'Patterson','William','x4871','wpatterson@realparssamplesql.com','6',1056,'Sales Manager (APAC)'),

(1102,'Bondur','Gerard','x5408','gbondur@realparssamplesql.com','4',1056,'Sale Manager (EMEA)'),

(1143,'Bow','Anthony','x5428','abow@realparssamplesql.com','1',1056,'Sales Manager (NA)'),

(1165,'Jennings','Leslie','x3291','ljennings@realparssamplesql.com','1',1143,'Sales Rep'),

(1166,'Thompson','Leslie','x4065','lthompson@realparssamplesql.com','1',1143,'Sales Rep'),

(1188,'Firrelli','Julie','x2173','jfirrelli@realparssamplesql.com','2',1143,'Sales Rep'),

(1216,'Patterson','Steve','x4334','spatterson@realparssamplesql.com','2',1143,'Sales Rep'),

(1286,'Tseng','Foon Yue','x2248','ftseng@realparssamplesql.com','3',1143,'Sales Rep'),

(1323,'Vanauf','George','x4102','gvanauf@realparssamplesql.com','3',1143,'Sales Rep'),

(1337,'Bondur','Loui','x6493','lbondur@realparssamplesql.com','4',1102,'Sales Rep'),

(1370,'Hernandez','Gerard','x2028','ghernande@realparssamplesql.com','4',1102,'Sales Rep'),

(1401,'Castillo','Pamela','x2759','pcastillo@realparssamplesql.com','4',1102,'Sales Rep'),

(1501,'Bott','Larry','x2311','lbott@realparssamplesql.com','7',1102,'Sales Rep'),

(1504,'Jones','Barry','x102','bjones@realparssamplesql.com','7',1102,'Sales Rep'),

(1611,'Fixter','Andy','x101','afixter@realparssamplesql.com','6',1088,'Sales Rep'),

(1612,'Marsh','Peter','x102','pmarsh@realparssamplesql.com','6',1088,'Sales Rep'),

(1619,'King','Tom','x103','tking@realparssamplesql.com','6',1088,'Sales Rep'),

(1621,'Nishi','Mami','x101','mnishi@realparssamplesql.com','5',1056,'Sales Rep'),

(1625,'Kato','Yoshimi','x102','ykato@realparssamplesql.com','5',1621,'Sales Rep'),

(1702,'Gerard','Martin','x2312','mgerard@realparssamplesql.com','4',1102,'Sales Rep');
...
insert  into `orderdetails`(`orderNumber`,`courseCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) values 
...
insert  into `orders`(`orderNumber`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`studentNumber`) values 
...
(10107,'2003-02-24','2003-03-03','2003-02-26','Shipped','Difficult to negotiate with student. We need more marketing materials',131),

(10108,'2003-03-03','2003-03-12','2003-03-08','Shipped',NULL,385),

(10109,'2003-03-10','2003-03-19','2003-03-11','Shipped','student requested that FedEx Ground is used for this shipping',486),

(10110,'2003-03-18','2003-03-24','2003-03-20','Shipped',NULL,187),

(10111,'2003-03-25','2003-03-31','2003-03-30','Shipped',NULL,129),

(10112,'2003-03-24','2003-04-03','2003-03-29','Shipped','student requested that ad materials (such as posters, pamphlets) be included in the shippment',144),
...
(10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','student has worked with some of our vendors in the past and is aware of their MSRP',216),
...
(10124,'2003-05-21','2003-05-29','2003-05-25','Shipped','student very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',112),

(10125,'2003-05-21','2003-05-27','2003-05-24','Shipped',NULL,114),

(10126,'2003-05-28','2003-06-07','2003-06-02','Shipped',NULL,458),

(10127,'2003-06-03','2003-06-09','2003-06-06','Shipped','student requested special shippment. The instructions were passed along to the warehouse',151),
...
(10136,'2003-07-04','2003-07-14','2003-07-06','Shipped','student is interested in buying more Ferrari models',242),
...
(10164,'2003-10-21','2003-10-30','2003-10-23','Resolved','This order was disputed, but resolved on 11/1/2003; student doesn\'t like the colors and precision of the models.',452),

(10165,'2003-10-22','2003-10-31','2003-12-26','Shipped','This order was on hold because students\'s credit limit had been exceeded. Order will ship when payment is received',148),

(10166,'2003-10-21','2003-10-30','2003-10-27','Shipped',NULL,462),

(10167,'2003-10-23','2003-10-30',NULL,'Cancelled','student called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.',448),
...
(10173,'2003-11-05','2003-11-15','2003-11-09','Shipped','Cautious optimism. We have happy students here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278),
...
(10179,'2003-11-11','2003-11-17','2003-11-13','Cancelled','student cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.',496),
...
(10191,'2003-11-20','2003-11-30','2003-11-24','Shipped','We must be cautions with this student. Their VP of Sales resigned. Company may be heading down.',259),
...
(10197,'2003-11-26','2003-12-02','2003-12-01','Shipped','student inquired about remote controlled models and gold models.',216),
...
(10213,'2004-01-22','2004-01-28','2004-01-27','Shipped','Difficult to negotiate with student. We need more marketing materials',489),

(10214,'2004-01-26','2004-02-04','2004-01-29','Shipped',NULL,458),

(10215,'2004-01-29','2004-02-08','2004-02-01','Shipped','student requested that FedEx Ground is used for this shipping',475),

(10216,'2004-02-02','2004-02-10','2004-02-04','Shipped',NULL,256),

(10217,'2004-02-04','2004-02-14','2004-02-06','Shipped',NULL,166),

(10218,'2004-02-09','2004-02-16','2004-02-11','Shipped','student requested that ad materials (such as posters, pamphlets) be included in the shippment',473),
...
(10224,'2004-02-21','2004-03-02','2004-02-26','Shipped','student has worked with some of our vendors in the past and is aware of their MSRP',171),
...
(10230,'2004-03-15','2004-03-24','2004-03-20','Shipped','student very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',128),

(10231,'2004-03-19','2004-03-26','2004-03-25','Shipped',NULL,344),

(10232,'2004-03-20','2004-03-30','2004-03-25','Shipped',NULL,240),

(10233,'2004-03-29','2004-04-04','2004-04-02','Shipped','student requested special shippment. The instructions were passed along to the warehouse',328),
...
(10242,'2004-04-20','2004-04-28','2004-04-25','Shipped','student is interested in buying more Ferrari models',456),
...
(10253,'2004-06-01','2004-06-09','2004-06-02','Cancelled','student disputed the order and we agreed to cancel it. We must be more cautions with this student going forward, since they are very hard to please. We must cover the shipping fees.',201),

(10254,'2004-06-03','2004-06-13','2004-06-04','Shipped','student requested that DHL is used for this shipping',323),
...
(10260,'2004-06-16','2004-06-22',NULL,'Cancelled','student heard complaints from their students and called to cancel this order. Will notify the Sales Manager.',357),

(10261,'2004-06-17','2004-06-25','2004-06-22','Shipped',NULL,233),

(10262,'2004-06-24','2004-07-01',NULL,'Cancelled','This student found a better offer from one of our competitors. Will call back to renegotiate.',141),

(10263,'2004-06-28','2004-07-04','2004-07-02','Shipped',NULL,175),

(10264,'2004-06-30','2004-07-06','2004-07-01','Shipped','student will send a truck to our local warehouse on 7/1/2004',362),
...
(10279,'2004-08-09','2004-08-19','2004-08-15','Shipped','Cautious optimism. We have happy students here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141),
...
(10297,'2004-09-16','2004-09-22','2004-09-21','Shipped','We must be cautions with this student. Their VP of Sales resigned. Company may be heading down.',189),
...
(10303,'2004-10-06','2004-10-14','2004-10-09','Shipped','student inquired about remote controlled models and gold models.',484),
...
(10308,'2004-10-15','2004-10-24','2004-10-20','Shipped','student requested that FedEx Ground is used for this shipping',319),

(10309,'2004-10-15','2004-10-24','2004-10-18','Shipped',NULL,121),

(10310,'2004-10-16','2004-10-24','2004-10-18','Shipped',NULL,259),

(10311,'2004-10-16','2004-10-23','2004-10-20','Shipped','Difficult to negotiate with student. We need more marketing materials',141),

(10312,'2004-10-21','2004-10-27','2004-10-23','Shipped',NULL,124),

(10313,'2004-10-22','2004-10-28','2004-10-25','Shipped','student requested that FedEx Ground is used for this shipping',202),

(10314,'2004-10-22','2004-11-01','2004-10-23','Shipped',NULL,227),

(10315,'2004-10-29','2004-11-08','2004-10-30','Shipped',NULL,119),

(10316,'2004-11-01','2004-11-09','2004-11-07','Shipped','student requested that ad materials (such as posters, pamphlets) be included in the shippment',240),

(10317,'2004-11-02','2004-11-12','2004-11-08','Shipped',NULL,161),

(10318,'2004-11-02','2004-11-09','2004-11-07','Shipped',NULL,157),

(10319,'2004-11-03','2004-11-11','2004-11-06','Shipped','student requested that DHL is used for this shipping',456),

(10320,'2004-11-03','2004-11-13','2004-11-07','Shipped',NULL,144),

(10321,'2004-11-04','2004-11-12','2004-11-07','Shipped',NULL,462),

(10322,'2004-11-04','2004-11-12','2004-11-10','Shipped','student has worked with some of our vendors in the past and is aware of their MSRP',363),
...
(10327,'2004-11-10','2004-11-19','2004-11-13','Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. student claims the scales of the models don\'t match what was discussed.',145),

(10328,'2004-11-12','2004-11-21','2004-11-18','Shipped','student very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',278),

(10329,'2004-11-15','2004-11-24','2004-11-16','Shipped',NULL,131),

(10330,'2004-11-16','2004-11-25','2004-11-21','Shipped',NULL,385),

(10331,'2004-11-17','2004-11-23','2004-11-23','Shipped','student requested special shippment. The instructions were passed along to the warehouse',486),

(10332,'2004-11-17','2004-11-25','2004-11-18','Shipped',NULL,187),

(10333,'2004-11-18','2004-11-27','2004-11-20','Shipped',NULL,129),

(10334,'2004-11-19','2004-11-28',NULL,'On Hold','The outstaniding balance for this student exceeds their credit limit. Order will be shipped when a payment is received.',144),

(10335,'2004-11-19','2004-11-29','2004-11-23','Shipped',NULL,124),

(10336,'2004-11-20','2004-11-26','2004-11-24','Shipped','student requested that DHL is used for this shipping',172),
...
(10340,'2004-11-24','2004-12-01','2004-11-25','Shipped','student is interested in buying more Ferrari models',216),
...
(10358,'2004-12-10','2004-12-16','2004-12-16','Shipped','student requested that DHL is used for this shipping',141),
...
(10367,'2005-01-12','2005-01-21','2005-01-16','Resolved','This order was disputed and resolved on 2/1/2005. student claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.',205),
...
(10377,'2005-02-09','2005-02-21','2005-02-12','Shipped','Cautious optimism. We have happy students here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186),
...
(10386,'2005-03-01','2005-03-09','2005-03-06','Resolved','Disputed then Resolved on 3/15/2005. student doesn\'t like the craftsmaship of the models.',141),
...
(10395,'2005-03-17','2005-03-24','2005-03-23','Shipped','We must be cautions with this student. Their VP of Sales resigned. Company may be heading down.',250),
...
(10400,'2005-04-01','2005-04-11','2005-04-04','Shipped','student requested that DHL is used for this shipping',450),

(10401,'2005-04-03','2005-04-14',NULL,'On Hold','student credit limit exceeded. Will ship when a payment is received.',328),
...
(10406,'2005-04-15','2005-04-25','2005-04-21','Disputed','student claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.',145),

(10407,'2005-04-22','2005-05-04',NULL,'On Hold','student credit limit exceeded. Will ship when a payment is received.',450),
...
(10413,'2005-05-05','2005-05-14','2005-05-09','Shipped','student requested that DHL is used for this shipping',175),

(10414,'2005-05-06','2005-05-13',NULL,'On Hold','student credit limit exceeded. Will ship when a payment is received.',362),

(10415,'2005-05-09','2005-05-20','2005-05-12','Disputed','student claims the scales of the models don\'t match what was discussed. I keep all the paperwork though to prove otherwise',471),

(10416,'2005-05-10','2005-05-16','2005-05-14','Shipped',NULL,386),

(10417,'2005-05-13','2005-05-19','2005-05-19','Disputed','student doesn\'t like the colors and precision of the models.',141),
...
insert  into `payments`(`studentNumber`,`checkNumber`,`paymentDate`,`amount`) values 
...
/*Table structure for table `courselines` */

DROP TABLE IF EXISTS `courselines`;
...
/*Data for the table `courselines` */

insert  into `courselines`(`courseLine`,`textDescription`,`htmlDescription`,`image`) values 

('PLC Progression-Level 1','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner.',NULL,NULL),

('PLC Progression-Level 2','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',NULL,NULL),

('PLC Progression-Level 3','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',NULL,NULL),

('PLC Progression-Level 4','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types. ',NULL,NULL),

('PLC Progression-Level 5','The next lessons then introduce you to V13 of step 7. We chat about installation and requirements, creating projects, hardware configuration, and writing programs in the new software version.',NULL,NULL),

('PLC Progression-Level 6','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',NULL,NULL),

('PLC Progression-Level 7','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',NULL,NULL);
...
insert  into `courses`(`courseCode`,`courseName`,`courseLine`,`courseScale`,`courseVendor`,`courseDescription`,`quantityInStock`,`buyPrice`,`MSRP`) values 

('S10_1678','learning the basics 1','PLC Progression-Level 1','1:10','Amirhossein Nourian','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner.',7933,'48.81','95.70'),

('S10_1949','the programming environment 1','PLC Progression-Level 2','1:10','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',7305,'98.58','214.30'),

('S10_2016','learning the basics 2','PLC Progression-Level 1','1:10','RealPars','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',6625,'68.99','118.94'),

('S10_4698','learning the basics 3','PLC Progression-Level 1','1:10','RealPars','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',5582,'91.02','193.66'),

('S10_4757','the programming environment 2','PLC Progression-Level 2','1:10','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',3252,'85.68','136.00'),

('S10_4962','the programming environment 3','PLC Progression-Level 2','1:10','Amirhossein Nourian','Features include: Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassisIn this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',6791,'103.42','147.74'),

('S12_1099','the programming environment 4','PLC Progression-Level 2','1:12','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',68,'95.34','194.57'),

('S12_1108','the programming environment 5','PLC Progression-Level 2','1:12','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',3619,'95.59','207.80'),

('S12_1666','understanding SQl 1','PLC Progression-Level 6','1:12','Amirhossein Nourian','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',1579,'77.90','136.67'),

('S12_2823','learning the basics 4','PLC Progression-Level 1','1:12','RealPars','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',9997,'66.27','150.62'),

('S12_3148','the programming environment 6','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',6906,'89.14','151.08'),

('S12_3380','the programming environment 7','PLC Progression-Level 2','1:12','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',9123,'75.16','117.44'),

('S12_3891','the programming environment 8','PLC Progression-Level 2','1:12','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',1049,'83.05','173.02'),

('S12_3990','the programming environment 9','PLC Progression-Level 2','1:12','Amirhossein Nourian','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',5663,'31.92','79.80'),

('S12_4473','understanding SQl 2','PLC Progression-Level 6','1:12','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',6125,'55.70','118.50'),

('S12_4675','the programming environment 10','PLC Progression-Level 2','1:12','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',7323,'58.73','115.16'),

('S18_1097','understanding SQl 3','PLC Progression-Level 6','1:18','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',2613,'58.33','116.67'),

('S18_1129','the programming environment 11','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',3975,'83.51','141.54'),

('S18_1342','discussing comparator instructions 1','PLC Progression-Level 7','1:18','Amirhossein Nourian','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',8693,'60.62','102.74'),

('S18_1367','discussing comparator instructions 2','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',8635,'24.26','53.91'),

('S18_1589','the programming environment 12','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',9042,'65.96','124.44'),

('S18_1662','the different timer types 1','PLC Progression-Level 3','1:18','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',5330,'77.27','157.69'),

('S18_1749','discussing comparator instructions 3','PLC Progression-Level 7','1:18','Wally Gastreich','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',2724,'86.70','170.00'),

('S18_1889','the programming environment 13','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',8826,'53.90','77.00'),

('S18_1984','the programming environment 14','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',9772,'93.89','142.25'),

('S18_2238','the programming environment 15','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',4724,'101.51','163.73'),

('S18_2248','discussing comparator instructions 4','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',540,'33.30','60.54'),

('S18_2319','understanding SQl 4','PLC Progression-Level 6','1:18','Amirhossein Nourian','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',8258,'74.86','122.73'),

('S18_2325','discussing comparator instructions 5','PLC Progression-Level 7','1:18','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',9354,'58.48','127.13'),

('S18_2432','understanding SQl 5','PLC Progression-Level 6','1:18','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',2018,'24.92','60.77'),

('S18_2581','the different timer types 2','PLC Progression-Level 3','1:72','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',992,'49.00','84.48'),

('S18_2625','learning the basics 5','PLC Progression-Level 1','1:18','Wally Gastreich','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',4357,'24.23','60.57'),

('S18_2795','discussing comparator instructions 6','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',548,'72.56','168.75'),

('S18_2870','the programming environment 16','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',8164,'56.76','132.00'),

('S18_2949','discussing comparator instructions 7','PLC Progression-Level 7','1:18','Amirhossein Nourian','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',4189,'60.78','101.31'),

('S18_2957','discussing comparator instructions 8','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',5649,'34.35','62.46'),

('S18_3029','the equals, less than, greater than type instructions 9','PLC Progression-Level 4','1:18','RealPars','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',4259,'51.61','86.02'),

('S18_3136','discussing comparator instructions 10','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',5992,'60.74','104.72'),

('S18_3140','discussing comparator instructions 11','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',3913,'68.30','136.59'),

('S18_3232','the programming environment 17','PLC Progression-Level 2','1:18','Amirhossein Nourian',' In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',8347,'77.90','169.34'),

('S18_3233','the programming environment 18','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',7733,'57.01','107.57'),

('S18_3259','explain Decimal, Binary, and BCD numbers 1','PLC Progression-Level 5','1:18','RealPars','The next lessons then introduce you to V13 of step 7. We chat about installation and requirements, creating projects, hardware configuration, and writing programs in the new software version.',6450,'67.56','100.84'),

('S18_3278','the programming environment 19','PLC Progression-Level 2','1:18','RealPars','TBD',1917,'49.05','80.41'),

('S18_3320','discussing comparator instructions 12','PLC Progression-Level 7','1:18','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',7913,'57.54','99.21'),

('S18_3482','the programming environment 20','PLC Progression-Level 2','1:18','RealPars',' In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',9127,'73.49','146.99'),

('S18_3685','the programming environment 21','PLC Progression-Level 2','1:18','RealPars','TBD',8990,'62.16','141.28'),

('S18_3782','learning the basics 12','PLC Progression-Level 1','1:18','Amirhossein Nourian','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',7689,'32.95','62.17'),

('S18_3856','discussing comparator instructions 12','PLC Progression-Level 7','1:18','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',2378,'64.58','105.87'),

('S18_4027','the programming environment 22','PLC Progression-Level 2','1:18','Amirhossein Nourian','TBD',5545,'91.92','143.62'),

('S18_4409','discussing comparator instructions 13','PLC Progression-Level 7','1:18','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',6553,'43.26','92.03'),

('S18_4522','discussing comparator instructions 14','PLC Progression-Level 7','1:18','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',8290,'52.66','87.77'),

('S18_4600','understanding SQl 6','PLC Progression-Level 6','1:18','RealPars',' Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',3128,'84.76','121.08'),

('S18_4668','discussing comparator instructions 15','PLC Progression-Level 7','1:18','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',6645,'23.14','50.31'),

('S18_4721','the programming environment 23','PLC Progression-Level 2','1:18','RealPars','TBD',1249,'69.93','148.80'),

('S18_4933','the programming environment 24','PLC Progression-Level 2','1:18','RealPars','TBD',3209,'34.21','71.27'),

('S24_1046','the programming environment 25','PLC Progression-Level 2','1:24','RealPars','TBD',1005,'49.24','73.49'),

('S24_1444','the programming environment 26','PLC Progression-Level 2','1:24','RealPars','TBD',4074,'32.37','57.80'),

('S24_1578','learning the basics 11','PLC Progression-Level 1','1:24','Shahpour Shapournia','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',7003,'60.86','112.70'),

('S24_1628','the programming environment 27','PLC Progression-Level 2','1:24','RealPars','TBD',8197,'29.18','50.31'),

('S24_1785','the different timer types 3','PLC Progression-Level 3','1:24','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',3627,'66.74','109.42'),

('S24_1937','discussing comparator instructions 16','PLC Progression-Level 7','1:24','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',7332,'22.57','33.19'),

('S24_2000','learning the basics 5','PLC Progression-Level 1','1:24','RealPars','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',15,'37.32','76.17'),

('S24_2011','the equals, less than, greater than type instructions 8','PLC Progression-Level 4','1:24','RealPars','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',1898,'82.34','122.89'),

('S24_2022','discussing comparator instructions 17','PLC Progression-Level 7','1:24','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',2847,'20.61','44.80'),

('S24_2300','understanding SQl 7','PLC Progression-Level 6','1:24','Shahpour Shapournia','TFollowing those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',2327,'61.34','127.79'),

('S24_2360','learning the basics 6','PLC Progression-Level 1','1:24','RealPars','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',6840,'47.10','69.26'),

('S24_2766','the programming environment 28','PLC Progression-Level 2','1:24','RealPars','TBD',2350,'47.25','90.87'),

('S24_2840','the programming environment 29','PLC Progression-Level 2','1:24','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',2542,'15.91','35.36'),

('S24_2841','the different timer types 4','PLC Progression-Level 3','1:24','Shahpour Shapournia','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',5942,'34.25','68.51'),

('S24_2887','the programming environment 30','PLC Progression-Level 2','1:24','Shahpour Shapournia','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',1452,'72.82','117.44'),

('S24_2972','the programming environment 31','PLC Progression-Level 2','1:24','Shahpour Shapournia','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',7723,'16.24','37.76'),

('S24_3151','discussing comparator instructions 18','PLC Progression-Level 7','1:24','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',9173,'46.91','88.51'),

('S24_3191','1969 Chevrolet Camaro Z28','PLC Progression-Level 2','1:24','Shahpour Shapournia','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',4695,'50.51','85.61'),

('S24_3371','the programming environment 32','PLC Progression-Level 2','1:24','Wally Gastreich','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',7995,'38.58','61.23'),

('S24_3420','discussing comparator instructions 19','PLC Progression-Level 7','1:24','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',2902,'26.30','65.75'),

('S24_3432','the programming environment 33','PLC Progression-Level 2','1:24','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',9446,'62.11','107.08'),

('S24_3816','discussing comparator instructions 20','PLC Progression-Level 7','1:24','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',6621,'48.64','83.86'),

('S24_3856','the programming environment 34','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',6600,'98.30','140.43'),

('S24_3949','the different timer types 5','PLC Progression-Level 3','1:24','Shahpour Shapournia','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',6812,'29.34','68.24'),

('S24_3969','discussing comparator instructions 21','PLC Progression-Level 7','1:24','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',2081,'21.75','41.03'),

('S24_4048','the programming environment 35','PLC Progression-Level 2','1:24','Shahpour Shapournia','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',6582,'69.78','118.28'),

('S24_4258','discussing comparator instructions 22','PLC Progression-Level 7','1:24','Shahpour Shapournia','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',4710,'57.46','97.39'),

('S24_4278','the different timer types 6','PLC Progression-Level 3','1:24','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',2756,'36.23','72.45'),

('S24_4620','the programming environment 36','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',7869,'32.33','80.84'),

('S32_1268','understanding SQl 8','PLC Progression-Level 6','1:32','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',5099,'53.93','96.31'),

('S32_1374','learning the basics 7','PLC Progression-Level 1','1:32','Shahpour Shapournia','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',178,'66.92','99.89'),

('S32_2206','learning the basics 8','PLC Progression-Level 1','1:32','RealPars','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',9241,'24.14','40.23'),

('S32_2509','understanding SQl 9','PLC Progression-Level 6','1:32','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',2874,'25.98','54.11'),

('S32_3207','explain Decimal, Binary, and BCD numbers 2','PLC Progression-Level 5','1:32','RealPars','The next lessons then introduce you to V13 of step 7. We chat about installation and requirements, creating projects, hardware configuration, and writing programs in the new software version.',8601,'26.72','62.14'),

('S32_3522','understanding SQl 10','PLC Progression-Level 6','1:32','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',814,'33.61','64.64'),

('S32_4289','discussing comparator instructions 23','PLC Progression-Level 7','1:32','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',136,'33.02','68.79'),

('S32_4485','learning the basics 9','PLC Progression-Level 1','1:32','Shahpour Shapournia','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',3341,'56.13','102.05'),

('S50_1341','discussing comparator instructions 24','PLC Progression-Level 7','1:50','RealPars','Once we get you reacquainted with the programming environment, we will write a program that will combine many of the previously used instructions. We will have a discussion about normally opened and normally closed contacts and the use of them in your programs.',7062,'27.06','43.64'),

('S50_1392','understanding SQl 11','PLC Progression-Level 6','1:50','RealPars','Following those tutorials, we introduce you to some math instructions, discuss some conversion instructions, write a program that will alarm when one of our turbine temperature sensors is out of range, explain Decimal, Binary, and BCD numbers, and finish off with another great work around for the counter maximum count restriction.',1016,'68.29','115.75'),

('S50_1514','explain Decimal, Binary, and BCD numbers 3','PLC Progression-Level 5','1:50','RealPars','The next lessons then introduce you to V13 of step 7. We chat about installation and requirements, creating projects, hardware configuration, and writing programs in the new software version.',1645,'37.49','58.58'),

('S50_4713','learning the basics 10','PLC Progression-Level 1','1:50','Shahpour Shapournia','Our training program starts with the beginner in mind and for that reason, the course material is explained in depth but with an ease of use manner',600,'34.17','81.36'),

('S700_1138','the equals, less than, greater than type instructions 7','PLC Progression-Level 4','1:700','Shahpour Shapournia','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',1897,'34.00','66.67'),

('S700_1691','the different timer types 7','PLC Progression-Level 3','1:700','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',5841,'51.15','91.34'),

('S700_1938','the equals, less than, greater than type instructions 6','PLC Progression-Level 4','1:700','RealPars','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',737,'43.30','86.61'),

('S700_2047','the equals, less than, greater than type instructions 5','PLC Progression-Level 4','1:700','RealPars','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',3501,'39.83','90.52'),

('S700_2466','the different timer types 8','PLC Progression-Level 3','1:700','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',9653,'68.80','99.72'),

('S700_2610','the equals, less than, greater than type instructions 4','PLC Progression-Level 4','1:700','RealPars','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',7083,'33.97','72.28'),

('S700_2824','the programming environment 36','PLC Progression-Level 2','1:18','RealPars','In this series, we are going to continue where we left off. We will first get you more familiar with the programming environment. Following that, we’ll discuss Input, Output, and memory addressing. We will then discuss how to address timers and counters.',6934,'46.53','101.15'),

('S700_2834','ATA: B757-300','PLC Progression-Level 3','1:700','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',7106,'59.33','118.65'),

('S700_3167','F/A 18 Hornet 1/72','PLC Progression-Level 3','1:72','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',551,'54.40','80.00'),

('S700_3505','the equals, less than, greater than type instructions 3','PLC Progression-Level 4','1:700','RealPars','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',1956,'51.09','100.17'),

('S700_3962','the equals, less than, greater than type instructions 2','PLC Progression-Level 4','1:700','Wally Gastreich','In this fourth series, we start off discussing comparator instructions which are the equals, less than, greater than type instructions and then jump right into demonstrating the differences of the many data types.',5088,'53.63','99.31'),

('S700_4002','the different timer types 9','PLC Progression-Level 3','1:700','Shahpour Shapournia','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',8820,'36.27','74.03'),

('S72_1253','the different timer types 10','PLC Progression-Level 3','1:72','RealPars','In this series, we begin by discussing the different timer types and write some universal code to use the timers under different scenarios.',4857,'32.77','49.66'),

('S72_3212','the equals, less than, greater than type instructions 1','PLC Progression-Level 4','1:72','RealPars','',414,'33.30','54.60');
